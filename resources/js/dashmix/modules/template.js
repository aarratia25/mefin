...
export default class Template {
    ...
    _uiHandleSidebars(mode) {
        ...
        if (mode === "init") {
            ...
            if (self._lPage.hasClass("side-scroll")) {
                ...
                if (
                    self._lSideOverlay.length > 0 &&
                    !self._lSideOverlayScroll
                ) {
                    self._lSideOverlayScroll = new SimpleBar(
                        self._lSideOverlay[0]
                    );
                ...
                if (self._lSidebar && self._lSidebarScroll) {
                    ...
                    self._lSidebar
                        ...
                        .html(
                            jQuery(".simplebar-content", self._lSidebar).html()
                        );
                }
    ...
    _uiHandleHeader() {
        ...
        if (
            self._lPage.hasClass("page-header-glass") &&
            self._lPage.hasClass("page-header-fixed")
        ) {
            jQuery(window)
                .on("scroll.pixelcave.header", e => {
        ...
        let blockAPI = {
            init: () => {
                ...
                jQuery(
                    ...
                    el.html(
                        '<i class="' +
                            (el.closest(".block").hasClass("block-mode-hidden")
                                ? iconContentActive
                                : iconContent) +
                            '"></i>'
                    );
            ...
            pinned_toggle: () => {
                elBlock
                    .removeClass("block-mode-fullscreen")
